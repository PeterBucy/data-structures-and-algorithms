...
const returnNames = (arr) => {
    return arr.reduce((myarray, character) => {
...
const reversedString = (arr) => {
    ...
    return arr.split('').reduce((myarray, mystring) => {
        mystring += myarray;
        return mystring;
      });
};
...
const countNumberOfChildren = (arr) => {
    return arr.reduce((myarray, kids) => {
        if (kids.children) 
        {myarray += kids.children.length;}
        return myarray;
      }, 0);
};
...
const calculateAverage = (arr) => {
  let value = arr.reduce((myarray, number) => {
    myarray.count++;
    myarray.sum += number;
    return myarray;
  }, {count: 0, sum: 0});
...
const countPrimeNumbers = (arr) => {
    return arr.reduce((myarray, numbers) => {
        if (isPrime(numbers)) 
        {myarray++;}
        return myarray;
      }, 0);
